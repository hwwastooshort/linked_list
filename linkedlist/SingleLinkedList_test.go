...
func TestSingleLinkedListWithNoEntries(t *testing.T) {
...
func TestSingleLinkedListWithOneEntry(t *testing.T) {
	list := NewSingleLinkedList[int]()
	list.InsertLast(10)
	expectedSize := 1
	actualSize := list.Size()
...
func TestSingleListWithMultipleEntries(t *testing.T) {
	list := NewSingleLinkedList[int]()
	for i := range 10 {
		list.InsertLast(i)
	}
...
func TestSingleLinkedListRemoveLastWhenListIsEmpty(t *testing.T) {
	list := NewSingleLinkedList[int]()
	_, err := list.RemoveLast()
	if err == nil {
		t.Errorf("expected error when removing from empty list, but got nil")
	}
}

func TestSingleLinkedListRemoveLastWithOneElement(t *testing.T) {
	list := NewSingleLinkedList[int]()
	list.InsertLast(10)
	expectedSize := 1
	actualSize := list.Size()
	...
	if removed != 10 {
		t.Errorf("expected removed value to be 10, but got %d", removed)
	}
	expectedSize = 0
	actualSize = list.Size()
	if actualSize != expectedSize {
...
func TestSingleLinkedListRemoveLastWithMultipleElements(t *testing.T) {
	list := NewSingleLinkedList[int]()
	list.InsertLast(1)
	list.InsertLast(2)
	list.InsertLast(3)
	...
	if removed != 3 {
		t.Errorf("expected removed value to be 3, but got %d", removed)
	}
	if list.Size() != 2 {
...
func TestSingleLinkedListGetWithNoElements(t *testing.T) {
...
func TestSingleLinkedListGetWithElements(t *testing.T) {
	list := NewSingleLinkedList[int]()
	list.InsertLast(10)
	list.InsertLast(20)
	list.InsertLast(30)
...
func TestSingleLinkedListRemoveAtWithEmptyList(t *testing.T) {
	list := NewSingleLinkedList[int]()
...
func TestSingleLinkedListRemoveAtWithOneElement(t *testing.T) {
	list := NewSingleLinkedList[int]()
	insertedValue := 10
...
func TestSingleLinkedListRemoveAtWithListWithMultilpeValues(t *testing.T) {
	list := NewSingleLinkedList[int]()
	for i := range 1000 {
		list.InsertLast(i)
	}
...
func TestSingleLinkedListInsertFirst(t *testing.T) {
	list := NewSingleLinkedList[int]()
...
func TestSingleLinkedListInsertAtAsLastElement(t *testing.T) {
	list := NewSingleLinkedList[int]()
	list.InsertAt(0, 10)
	if list.Size() != 1 {
